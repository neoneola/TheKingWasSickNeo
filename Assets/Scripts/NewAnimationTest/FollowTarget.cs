...
public class FollowTarget: MonoBehaviour 
{
	...
	public bool assignedPlayer = false; //if this script knows which character should follow. This variable should be assigned
	//when a scene starts.
	...
	public void setPlayer(string name){
		//add command here: ex. when wolf and hermit are in the same screen, wolf chase the hermit(assign the target with hermit)
